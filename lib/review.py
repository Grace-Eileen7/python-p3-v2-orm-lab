...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year          # will go through property setter
        self.summary = summary    # property setter
        self.employee_id = employee_id  # property setter
    ...
    def save(self):
        ...
        if self.id:  # already in DB → update instead
            self.update()
        else:
            sql = """
